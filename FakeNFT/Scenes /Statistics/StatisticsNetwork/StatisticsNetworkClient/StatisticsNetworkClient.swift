...
enum StatisticsNetworkClientError: Error {
...
struct StatisticsDefaultNetworkClient: StatisticsNetworkClient {
    ...
    func send(
        ...
        return StatisticsDefaultNetworkTask(dataTask: task)
    }
    ...
    private func create(request: StatisticsNetworkRequest) -> URLRequest? {
