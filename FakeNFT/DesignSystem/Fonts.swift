...
struct Fonts {
    // MARK: - Bold Fonts
    static let sfProBold34 = UIFont(name: "SFProDisplay-Bold", size: 34) ?? UIFont.systemFont(ofSize: 34, weight: .bold)
    static let sfProBold28 = UIFont(name: "SFProDisplay-Bold", size: 28) ?? UIFont.systemFont(ofSize: 28, weight: .bold)
    static let sfProBold22 = UIFont(name: "SFProDisplay-Bold", size: 22) ?? UIFont.systemFont(ofSize: 22, weight: .bold)
    static let sfProBold20 = UIFont(name: "SFProDisplay-Bold", size: 20) ?? UIFont.systemFont(ofSize: 20, weight: .bold)
